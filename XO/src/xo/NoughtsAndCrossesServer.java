...
public class NoughtsAndCrossesServer extends Application
    implements NoughtsAndCrossesConstants{
    
    private int sessionNo = 1;
    private final int SOCKET = 8000;
	...
	primaryStage.setTitle("Noughts and Crosses Server");
	...
	new Thread(() -> {
		try{
		    ...
		    Platform.runLater(() -> taLog.appendText(new Date() +
							     ": Server started at socket " + SOCKET + "\n"));
    ...
    class HandleASession implements Runnable, NoughtsAndCrossesConstants{
